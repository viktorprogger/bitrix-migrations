...
class MIgrateCommandTest extends TestCase
{
    ...
    {
        return m::mock('Arrilot\BitrixMigrations\Commands\MigrateCommand[abort, info, getMigrationObjectByFileName]', [$this->getConfig(), $database, $files])
    ...
    public function testItMigratesOutstandingMigrations()
    {
        ...
        $command->shouldReceive('info')->with('Migrated: 2015_11_26_162220_bar')->once();
